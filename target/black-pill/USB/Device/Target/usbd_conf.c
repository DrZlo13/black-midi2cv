...
#include <usb_midi_device/usbd_midi.h>
...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  /* USER CODE BEGIN USB_OTG_FS_MspInit 0 */
    ...
    LL_GPIO_InitTypeDef LLGPIO_InitStruct = {0};
    LLGPIO_InitStruct.Pin = GPIO_PIN_11|GPIO_PIN_12;
    LLGPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
    LLGPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
    LLGPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
    LLGPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
    LLGPIO_InitStruct.Alternate = LL_GPIO_AF_10;
    LL_GPIO_Init(GPIOA, &LLGPIO_InitStruct);
